...
<script type="text/javascript" src="<?php echo backoffice_url ?>/libs/chosen-jquery/chosen.jquery.min.js"></script>
<link type="text/css" rel="stylesheet" href="<?php echo backoffice_url ?>/libs/chosen-jquery/chosen.css">

<link href="<?php echo backoffice_url ?>/libs/bootstrap-fileupload/bootstrap-fileupload.min.css" rel="stylesheet" />
<script type="text/javascript" src="<?php echo backoffice_url ?>/libs//bootstrap-fileupload/bootstrap-fileupload.min.js"></script>
    ...
    <div class="col-sm-12">
        <section class="row">
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <p class="hidden-sm-down" style='margin:0px;'>Manage your website settings here</p>
                <hr>
            </div>
                ...
                <form class="bs-example form-horizontal" name="csrf_form" data-validate="parsley" action="" method="post" enctype="multipart/form-data">
                    <div class="bs-example bs-example-tabs">
                        ...
                        <ul id="myTab" class="nav nav-tabs" >
                            <li class="nav-item"><a href="#sitesettings" class="nav-link active" data-toggle="tab">Site Settings</a></li>
                            <li class="nav-item"><a class="nav-link" href="#seosettings" data-toggle="tab">SEO Settings</a></li>

                            <li class="nav-item"><a class="nav-link" href="#socialsettings" data-toggle="tab">Social Settings</a></li>
                            <li class="nav-item"><a class="nav-link" href="#mailsettings" data-toggle="tab">Mail Settings</a></li>
                        </ul>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <select data-placeholder="Choose a country..." class="form-control chosen-select"  name="data[<?php echo $value['setting_name']; ?>]" id="<?php echo $value['setting_name']; ?>">
                                                                ...
                                                                <option <?php if ($value['setting_value'] == "system") echo "selected='selected'" ?> value='system'>System</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-9">
                                                            ...
                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                <div class="fileupload-new thumbnail" style="width: auto; height: auto; background: #f5f5f5"><img  style="width: auto; height: auto;" id="<?php echo $value['Field']; ?>" src="<?php echo backoffice_url . $value['setting_value']; ?>" /></div>
                                    ...
                                    <div class="panel-body">
                                        <div class="col-lg-7">
                                            ...
                                            foreach ($this->setting_array['seo'] as $key => $value) {
                                                ...
                                                <?php } else {
                                                     if($value['setting_name'] !== "main_url" && $value['setting_name'] !== "backoffice_url"){
                                                    ?>
                    ...
                    <div class="form-group" style="background:#eeeeee; margin-left:5px; padding:15px;margin: -40px; margin-top: 40px;">
                        <div class="col-lg-12" style="text-align:left">
                            <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Save All Setttings</button>
                        </div>
                    </div>
                </form>
