...
if(! defined('MAX_WIDTH') )					define ('MAX_WIDTH', 11500);								// Maximum image width
if(! defined('MAX_HEIGHT') )				define ('MAX_HEIGHT', 11500);							// Maximum image height
if(! defined('NOT_FOUND_IMAGE') )			define ('NOT_FOUND_IMAGE', 'http://placehold.it/300x240&text=Not+Found');							// Image to serve if any 404 occurs 
if(! defined('ERROR_IMAGE') )				define ('ERROR_IMAGE', 'http://placehold.it/300x240&text=Error');								// Image to serve if an error occurs instead of showing error message 
